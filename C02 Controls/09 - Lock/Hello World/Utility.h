...
// Position X & Y (not leading & Y)
#define CONSTRAINT_POSITION_X(VIEW, X) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeLeft relatedBy: NSLayoutRelationEqual toItem: [VIEW superview] attribute: NSLayoutAttributeLeft multiplier: 1.0f constant: X]
#define CONSTRAINT_POSITION_LEADING(VIEW, X) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeLeading relatedBy: NSLayoutRelationEqual toItem: [VIEW superview] attribute: NSLayoutAttributeLeading multiplier: 1.0f constant: X]
#define CONSTRAINT_POSITION_Y(VIEW, Y) [NSLayoutConstraint constraintWithItem: VIEW attribute: NSLayoutAttributeTop relatedBy: NSLayoutRelationEqual toItem: [VIEW superview] attribute: NSLayoutAttributeTop multiplier: 1.0f constant: Y]
#define CONSTRAINTS_POSITION(VIEW, X, Y) @[CONSTRAINT_POSITION_X(VIEW, X), CONSTRAINT_POSITION_Y(VIEW, Y)]
