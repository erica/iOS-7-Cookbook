...
// Align to parent
#define CONSTRAINT_FOR_ALIGN_VIEW_TOP_CONSTANT(PARENT, VIEW, CONSTANT) [NSLayoutConstraint constraintWithItem:VIEW attribute: NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:PARENT attribute:NSLayoutAttributeTop multiplier:1.0f constant:CONSTANT]
